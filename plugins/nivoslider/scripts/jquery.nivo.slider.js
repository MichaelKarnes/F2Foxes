...
(function ($) {
    ...
    var NivoSlider = function (element, options) {
        ...
        slider.css('background', 'url(' + vars.currentImage.attr('src') + ') center center no-repeat');
        if (settings.fit == 'fill') {
            var imgWidth = vars.currentImage.attr('width');
            var imgHeight = vars.currentImage.attr('height');
            if (imgWidth / slider.width() < imgHeight / slider.height())
                slider.css('background-size', '100% auto');
            else
        ...
        var nivoRun = function (slider, kids, settings, nudge) {
            ...
            if (settings.effect == 'sliceDown' || settings.effect == 'sliceDownRight' || vars.randAnim == 'sliceDownRight' ||
                ...
                $('.nivo-slice', slider).each(function () {
                    ...
                    if (i == settings.slices - 1) {
                        setTimeout(function () {
                            slice.animate({ width: sliceWidth, opacity: '1.0' }, settings.animSpeed, '', function () { slider.trigger('nivo:animFinished'); });
                        }, (100 + timeBuff));
                    } else {
                        setTimeout(function () {
                            slice.animate({ width: sliceWidth, opacity: '1.0' }, settings.animSpeed);
                        }, (100 + timeBuff));
                    }
                    timeBuff += 50;
                    i++;
